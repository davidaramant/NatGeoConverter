...
WriteLiteral(" class=\"glyphicon glyphicon glyphicon-resize-horizontal\"");
...
WriteLiteral(" class=\"glyphicon glyphicon glyphicon-resize-vertical\"");

WriteLiteral("/></button>  \t\t\t\t\t\t\t\t\t\t\n");


#line 43 "SiteLayout.cshtml"
